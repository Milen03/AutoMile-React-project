                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      name="brand"
                      type="text"
                      className="block w-100 rounded-md bg-gray-900 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-gray-600 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm"
                    />
                  </div>
                </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2 grid grid-cols-1">
                    <select
                      ...
                      className="col-start-1 row-start-1 w-full appearance-none rounded-md bg-gray-900 py-1.5 pr-8 pl-3 text-base text-white outline-1 -outline-offset-1 outline-gray-600 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm"
                    >
                      <option>Diesel</option>
                      <option>Petrol</option>
                      <option>Еlectric</option>
                    </select>
                    <ChevronDownIcon
                      aria-hidden="true"
